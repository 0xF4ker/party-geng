...
const ActionBadge = ({ action }: { action: string }) => {
  ...
  if (action.includes("PAYOUT") || action.includes("TRANSFER"))
        ...
        <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:items-center">
          <div className="relative w-full sm:w-64">
            ...
            <Input
              ...
              className="h-10 w-full rounded-lg border-gray-200 bg-gray-50 pl-9 transition-colors focus:bg-white"
              value={userSearch}
              onChange={(e) => {
          ...
          >
            <SelectTrigger className="h-10 w-full border-gray-200 bg-gray-50 focus:bg-white sm:w-[180px]">
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {log.entityType ? (
                        <div className="flex items-center gap-2 text-xs">
                          <Badge
                            variant="outline"
                            className="border-gray-200 bg-gray-50 font-normal text-gray-500"
                          >
                            {log.entityType}
                          </Badge>
                          <span
                    ...
                    <td className="px-6 py-4 text-right">
                      <Button
                        ...
                        className="text-gray-400 hover:bg-pink-50 hover:text-pink-600"
                      >
              ...
              >
                ...
                <div className="flex items-center justify-between border-t border-gray-50 pt-3">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => handleViewLog(log)}
                    className="h-8 text-pink-600 hover:bg-pink-50 hover:text-pink-700"
                  >
                    View Details
                  </Button>
                </div>
            ...
            <>
              <SheetHeader className="border-b border-gray-100 pb-6">
                <div className="mb-2 flex items-center gap-2">
                  <Badge variant="outline" className="font-mono text-xs">
                    LOG #{selectedLog.id.slice(0, 6)}
                  </Badge>
                  <span className="text-xs text-gray-400">
                    {format(new Date(selectedLog.createdAt), "HH:mm")}
                  </span>
                </div>
              ...
              <div className="flex-1 space-y-6 overflow-y-auto py-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="overflow-x-auto rounded-xl border border-gray-800 bg-[#0F172A] p-4 shadow-inner">
                    <pre className="font-mono text-xs leading-relaxed whitespace-pre-wrap text-emerald-400">
                      {JSON.stringify(selectedLog.details, null, 2) ||
                        "// No additional details recorded"}
                    </pre>
                  </div>
                  <p className="text-[10px] text-gray-500">
                    * This JSON payload represents the metadata captured at the
                    exact moment of the event.
                  </p>
                </div>
              </div>
