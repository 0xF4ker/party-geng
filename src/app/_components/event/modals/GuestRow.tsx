...
export const GuestRow = ({
        ...
        utils.event.getById.setData({ id: eventId }, (oldEvent) => {
          ...
          return {
            ...
            guestLists: [
              {
                ...oldEvent.guestLists[0],
                guests: oldEvent.guestLists[0].guests.filter(
                  (g) => g.id !== guestId,
                ),
              },
            ],
    ...
    return (
      <TableRow>
        ...
        <TableCell>
          <Badge
            className={
              statusColors[guest.status] ?? "bg-gray-100 text-gray-800"
            }
          >
            {guest.status}
          </Badge>
  ...
  return (
    <TableRow key={guest.id}>
      ...
      <TableCell>
        <Badge
          className={statusColors[guest.status] ?? "bg-gray-100 text-gray-800"}
        >
          {guest.status}
        </Badge>
      </TableCell>
